...
public class window_10_FFox_Selenium{
    WebDriver driver;
    Tunnel t;
    ...
    public void setUp(String browserVersion,String platform,String username,String access_key) throws Exception { 
		...
		ltOptions.put("build", "Build Selenium java 101 FireFox - "+platform);
		ltOptions.put("name", "TC Run Selenium java 101 FireFox -" + platform);
